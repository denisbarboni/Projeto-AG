        ...
        <nav id="tf-menu" class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">Algoritmo Genético</a>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" runat="server">
                            ...
                            <div class="modal-footer">
                                <button type="submit" id="btnCadastrar" class="form-control btn btn-primary" runat="server" onserverclick="btnCadastrar_ServerClick">Cadastrar</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.modal-body -->
